...
namespace Fody.Simulations
{
    ...
    public class FieldSimulation(TypeSimulation declaringType, FieldDefinition fieldDef) : Simulation(declaringType.ModuleWeaver), IHost, IAssignable
    {
    ...
    public class FieldSimulation<T>(TypeSimulation declaringType, FieldDefinition fieldDef) : FieldSimulation(declaringType, fieldDef) where T : TypeSimulation
    {
        private T? _value;
    ...
    public static class FieldSimulationExtensions
    {
