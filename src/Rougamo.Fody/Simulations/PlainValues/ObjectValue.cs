...
namespace Rougamo.Fody.Simulations.PlainValues
{
    ...
    internal class ObjectValue(object value, TypeReference valueTypeRef, ModuleWeaver moduleWeaver) : PlainValueSimulation(moduleWeaver), IParameterSimulation
    {
    ...
    {
        public static ObjectValue Simulate(this CustomAttributeArgument attributeArgument, ModuleWeaver moduleWeaver)
        {
