...
{
    public class TsArray(TypeReference typeRef, IHost? host, SimulationModuleWeaver moduleWeaver) : TsArray<TypeSimulation>(typeRef, host, moduleWeaver) { }

    public class TsArray<T> : TypeSimulation, IDisposable where T : TypeSimulation
    {
        private readonly OpCode _ldCode;
        private readonly OpCode _stCode;
        private bool _dupScope;

        public TsArray(TypeReference typeRef, IHost? host, SimulationModuleWeaver moduleWeaver) : base(typeRef, host, moduleWeaver)
        {
    ...
    public static class TsArrayExtensions
    {
