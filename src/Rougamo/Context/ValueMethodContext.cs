...
namespace Rougamo.Context
{
    ...
    /// </summary>
    public struct ValueMethodContext
    {
        ...
        /// <summary>
        /// </summary>
        public ValueMethodContext(object target, Type targetType, MethodBase method, bool isAsync, bool isIterator, bool mosNonEntryFIFO, IMo[] mos, object[] args)
        {
            Target = target;
